...
<nav>
  ...
  <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons">menu</i></a>
    <ul>
      <li><a href="#!"><i class="material-icons left">web</i>Elearning</a></li>
      <li><a href="#!" class="active"><i class="material-icons left">message</i>Blog</a></li>
      <li><a href="#!"><i class="material-icons left">people</i>About</a></li>
      <li><a href="#!"><i class="material-icons left">contact_mail</i>Contact</a></li>
    </ul>
  </div>
</nav>
